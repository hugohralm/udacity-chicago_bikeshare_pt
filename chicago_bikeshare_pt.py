...
def column_to_list(data, index):
    ...
    Função que adiciona as colunas(features) de uma lista em outra lista, na mesma ordem.
        Argumentos:
            data: A lista de dados.
            index: O indice da coluna.
        Retorna:
            Lista com os valores da coluna escolhida pelo indice 'index'
    """
    column_list = []
...
def count_elements(data, type):
    """
    Função que conta os elementos em uma lista.
        Argumentos:
            data: lista de dados.
            type: elemento para contar.
        Retorna:
            Valor de elementos encontrados na lista
    """
    count = 0
    for element in data:
        if element == type:
...
male = count_elements(gender, "Male")
female = count_elements(gender, "Female")
...
def count_user_type(data_list):
    """
    Função obtem tipos usuário da lista por impressão na legenda do mapa.
      Argumentos:
          data_list: lista de tipos de usuários.
      Retorna:
          Matriz com tipos de usuário.
    """
...
answer = "Porque existem algumas linhas com o gênero não preenchido."
...
def sum_elements(data):
    ...
    Função que soma os elementos de uma lista.
      Argumentos:
          data: lista para a soma (list).
      Retorna:
          Soma dos elementos encontrado na lista.
    """
    sum = 0
    for ele in data:
        sum += ele
...
def median(list):
    """
    Função que obtem o número médio da lista.
      Argumentos:
          list: lista de números para calcular.
      Retorna:
          Resultado do número calculado mediano da lista.
    """
    n = len(list)
    if n < 1:
        return None
    if n % 2 == 1:
        ...
        return sum_elements(sorted(list)[n // 2 - 1:n // 2 + 1]) / 2.0

def minmax(list):
    """
    Função que obtem o número mínimo e máximo da lista
      Argumentos:
          list: lista de números para calcular.
      Retorna:
          Matriz resultado do número calculado min e max da lista.
    """
...
def mean(list):
    ...
    Função que obtem o número médio da lista.
      Argumentos:
          list: lista para a soma.
      Retorna:
          Resultado do número meio de calculado da lista.
    """
    return sum_elements(map(int, list)) / len(list);
